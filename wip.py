...
ROOT.withdraw()
# the input dialog
USER_INP_uName = simpledialog.askstring(title="name", prompt="What's your Name?:")
USER_INP_uGender = simpledialog.askstring(title="Gender", prompt="Enter your Gender M (or) F:")
USER_INP_uHeight = simpledialog.askstring(title="Height", prompt="Enter Height in Meters:")
USER_INP_uWeight = simpledialog.askstring(title="Weight", prompt="Enter Weight in Kilograms:")
uName = USER_INP_uName
uGender = USER_INP_uGender.lstrip()[0]
uHeight = float(USER_INP_uHeight)
uWeight = float(USER_INP_uWeight)
# check it out
